...
const exps = [
  ...
  {
    label: 'Quality Thesis',
    value: '200+',
  },
  {
    label: 'Experience Faculty',
    value: '10+',
  },
]
            ...
            >
              ...
              <Box sx={{ mb: 4, width: { xs: '100%', md: '70%' } }}>
                <Typography sx={{ color: 'text.secondary', lineHeight: 1.6 }}>
                  {
                    "Let's join the thesis forum to improve your skills in a different way, "+
                    "you can find high-quality theses with detailed accompanying reports."+
